...
import update_data
import storage_parallel_processing

def main():
    # Data ingestion
    try:
        print("Data ingestion process started...")
        data_ingestion.main() # call the necessary functions
    ...
    try:
        ...
        data_transformation.main() # call the necessary functions
    ...
    try:
        ...
        storage_parallel_processing.main() # call the necessary functions
